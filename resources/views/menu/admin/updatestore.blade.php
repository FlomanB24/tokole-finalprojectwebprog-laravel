...
@section('container')
    ...
    <div class="col-md-12 mb-5">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-dark fw-bold"><a href="/admin-view-store" class="t-decor">All Store</a></li>
    ...
    <div class="ftmg-bottom2">
        <form class="mt-u" action="{{ route('admin-update-store', $store->id) }}" method="POST"
